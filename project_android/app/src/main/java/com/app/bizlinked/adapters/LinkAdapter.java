...
public class LinkAdapter extends RecyclerView.Adapter<LinkAdapter.MyViewHolder> {
    ...
    public LinkAdapter(Context context, ArrayList<LinkViewModel> data, DataRecyclerViewClickInterface<LinkViewModel> dataRecyclerViewClickInterface) {
...
//        this.data = data;
    ...
    public LinkAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.item_customer_supplier, parent, false);
...
//        AnimationHelpers.animate(Techniques.SlideInDown, 700, holder.llMainView);
    ...
    public LinkViewModel getItem(int position) {
